...
RSpec.describe "Edge case handling" do
  it "handles circular references gracefully" do
    ...
    begin
      ...
      expect(e.structured_data[:actual]).to be_a(Array)
    end
  end
  ...
  it "handles matchers without expected/actual methods" do
    ...
    expect(e.structured_data[:expected]).to be_nil
    expect(e.structured_data[:actual]).to be_nil
  end
  ...
  it "handles encoding issues" do
    ...
    begin
      ...
      expect(e.structured_data).to have_key(:actual)
    end
  end
